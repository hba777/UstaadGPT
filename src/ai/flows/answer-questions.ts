...
/**
 * @fileOverview A question answering AI agent that answers questions based on the uploaded documents.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI chatbot that answers questions based on the given context.
